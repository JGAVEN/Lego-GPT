...
| F-13 | **C**  | Offline collaboration queue                          | **Done** | Edits stored offline and synced |
| F-14 | **C**  | Push notifications                                   | **Done** | Browser alerts for collab edits |
| F-15 | **C**  | French translations                                  | **Done** | Third language option in PWA |
